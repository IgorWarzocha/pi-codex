...
- Restricted published provider exports to OpenAI Codex and removed the legacy compatibility, OAuth, Bedrock, Bun OAuth, generic API, and `pi-ai` CLI entrypoints.

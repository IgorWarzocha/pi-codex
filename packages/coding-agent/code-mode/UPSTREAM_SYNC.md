...
Upstream test modules are omitted. Pi-owned TypeScript, TOML discovery, command execution, package manifests, installer scripts, and minimal Cargo packaging stay outside upstream source trees. Keep mode activation and nested tool adapters in `src/tools/code-mode/`.

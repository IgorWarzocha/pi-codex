...
import type { WebSocketLike } from "../codex-transport.ts";
import { closeWebSocketSilently, connectWebSocket, extractWebSocketError } from "../codex-transport.ts";
import { type PromiseResolvers, promiseWithResolvers } from "../promise-resolvers.ts";
...
export class CodexDictationTranscriber {
	...
	private completion: PromiseResolvers<string | undefined> | undefined;
	...
	async finish(): Promise<string | undefined> {
		...
		const completion = promiseWithResolvers<string | undefined>();

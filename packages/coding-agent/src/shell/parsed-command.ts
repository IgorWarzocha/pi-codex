...
export function listCommand(mainCommand: string[], path: string | undefined): ParsedShellCommand {
	return {
		kind: "list",
...
export function searchCommand(mainCommand: string[], query: string, path: string | undefined): ParsedShellCommand {
	return {
		kind: "search",
		command: joinCommandTokens(mainCommand),
		query,
...
export function readCommand(mainCommand: string[], path: string): ParsedShellCommand {
	return {
		kind: "read",
		command: joinCommandTokens(mainCommand),
...
export function readOrUnknown(mainCommand: string[], path: string | undefined): ParsedShellCommand {

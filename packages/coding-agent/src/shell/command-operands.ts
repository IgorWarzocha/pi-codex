...
export function firstNonFlagOperand(args: string[], flagsWithValues: string[]): string | undefined {
	return positionalOperands(args, flagsWithValues)[0]!;
}

export function singleNonFlagOperand(args: string[], flagsWithValues: string[]): string | undefined {
...
export function parseFdQueryAndPath(args: string[]): [string | undefined, string | undefined] {
	const trimmed = trimAtConnector(args);
...
export function parseFindQueryAndPath(args: string[]): [string | undefined, string | undefined] {
	const trimmed = trimAtConnector(args);
...
export function readPathFromHeadTail(args: string[], tool: "head" | "tail"): string | undefined {

...
import { type CodexCompactionDiagnostic, isCodexCompactionDiagnostic } from "./diagnostics.ts";
...
export function isNativeCompactionUsage(value: unknown): value is NativeCompactionUsage {
	...
	return (
		[value["inputTokens"], value["cachedInputTokens"], value["cacheWriteInputTokens"], value["outputTokens"]].every(

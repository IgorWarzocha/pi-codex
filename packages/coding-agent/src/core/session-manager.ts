 ...
 * Encodes cwd into a safe directory name under the active agent directory's sessions/ folder.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses the active agent directory's sessions folder.
	 */

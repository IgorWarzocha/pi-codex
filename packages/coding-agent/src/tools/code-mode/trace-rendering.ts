...
function withoutEmittedImages(trace: RuntimeToolTrace, emittedImages: Map<string, Set<string>>): RuntimeToolTrace {
...
function renderGenericTraceCall(trace: RuntimeToolTrace, theme: CodeModeRenderTheme, expanded: boolean): Text {
...
function renderGenericTraceResult(trace: RuntimeToolTrace, theme: CodeModeRenderTheme, full: boolean): Component {
...
function isProgrammaticTool(tool: CodeModeToolDefinition | undefined): tool is ProgrammaticCodeModeToolDefinition {

...
function isUnifiedExecResult(details: unknown): details is UnifiedExecResult {
	return (
		typeof details === "object" && details !== null && typeof (details as { output?: unknown }).output === "string"
	);
}
...
export function createWriteStdinTool(
	...
	options: { promptSnippet?: boolean | undefined; showOutputWhenCollapsed?: boolean | undefined } = {},
) {
...
export function registerWriteStdinTool(
	...
	pi.registerTool(createWriteStdinTool(sessions, options) as never);
}

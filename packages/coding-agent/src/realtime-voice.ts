...
export function reportRealtimeVoicePrompt(pi: Pick<ExtensionAPI, "events">, report: RealtimeVoicePromptReport): void {
...
export function parseRealtimeVoicePrompt(value: unknown): RealtimeVoicePromptReport | undefined {
